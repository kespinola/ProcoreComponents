...
var ProcoreComponents = {
  ...
  Components: {
    ...
    Collapsible: require('./components/Collapsible.react'),
    ...
    FormFooter: require('./components/FormFooter.react'),
    If: require("./components/If.react"),
    Input: require("./components/Input.react"),
    LabelProgressCircle: require("./components/LabelProgressCircle.react"),
    List: require("./components/List.react"),
    MainPanelButtons: require("./components/MainPanelButtons.react"),
    NotificationBanner: require("./components/NotificationBanner.react"),
    ...
    ProgressCircle: require("./components/ProgressCircle.react"),
